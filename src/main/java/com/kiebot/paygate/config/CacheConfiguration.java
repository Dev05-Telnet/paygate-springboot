package com.kiebot.paygate.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kiebot.paygate.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kiebot.paygate.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.kiebot.paygate.domain.User.class.getName());
