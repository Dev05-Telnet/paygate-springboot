...
class TransactionResourceIT {
    ...
    public static Transaction createEntity(EntityManager em) {
        Transaction transaction = new Transaction().orderId(DEFAULT_ORDER_ID).payRequestId(DEFAULT_PAY_REQUEST_ID);
        return transaction;
    }
    ...
    public static Transaction createUpdatedEntity(EntityManager em) {
        Transaction transaction = new Transaction().orderId(UPDATED_ORDER_ID).payRequestId(UPDATED_PAY_REQUEST_ID);
        return transaction;
    }
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getPayRequestId()).isEqualTo(DEFAULT_PAY_REQUEST_ID);
    }
    ...
    void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.[*].payRequestId").value(hasItem(DEFAULT_PAY_REQUEST_ID)));
    }
    ...
    void getTransaction() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.payRequestId").value(DEFAULT_PAY_REQUEST_ID));
    }
    ...
    void putNewTransaction() throws Exception {
        ...
        updatedTransaction.orderId(UPDATED_ORDER_ID).payRequestId(UPDATED_PAY_REQUEST_ID);
        ...
        assertThat(testTransaction.getPayRequestId()).isEqualTo(UPDATED_PAY_REQUEST_ID);
    }
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.payRequestId(UPDATED_PAY_REQUEST_ID);
    ...
    void fullUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.orderId(UPDATED_ORDER_ID).payRequestId(UPDATED_PAY_REQUEST_ID);
