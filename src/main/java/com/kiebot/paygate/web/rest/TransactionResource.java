...
/**
 * REST controller for managing {@link com.kiebot.paygate.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingTransaction -> {
                    if (transaction.getOrderId() != null) {
                        existingTransaction.setOrderId(transaction.getOrderId());
                    }
                    if (transaction.getPayRequestId() != null) {
                        existingTransaction.setPayRequestId(transaction.getPayRequestId());
                    }
